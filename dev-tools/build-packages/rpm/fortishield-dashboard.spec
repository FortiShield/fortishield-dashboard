...
# Foundation.
Summary:     Fortishield dashboard is a user interface and visualization tool for security-related data. Documentation can be found at https://fortishield.github.io/documentation/current/getting-started/components/fortishield-dashboard.html
...
%global DASHBOARD_FILE fortishield-dashboard.tar.gz
...
cp fortishield-dashboard-base/config/node.options %{buildroot}%{CONFIG_DIR}
cp fortishield-dashboard-base/config/opensearch_dashboards.yml %{buildroot}%{CONFIG_DIR}
...
%attr(0750, %{USER}, %{GROUP}) "/etc/default/fortishield-dashboard"
...
%changelog
* Fri May 05 2023 support <info@fortishield.github.io> - %{version}
- More info: https://fortishield.github.io/documentation/current/release-notes/
