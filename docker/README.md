...
2. Clone the [fortishield-dashboard][app-repo] and the [fortishield-security-dashboards-plugin][security-repo]
...
Once the `fortishield-dashboard` container is up, attach a shell to it and run `yarn start --no-base-path`
...
[app-repo]: https://github.com/fortishield/fortishield-dashboard
[security-repo]: https://github.com/fortishield/fortishield-security-dashboards-plugin
