...
const createSetupContractMock = () => {
  const setupContract: jest.Mocked<InjectedMetadataSetup> = {
    ...
    getBranding: jest.fn(),
    getSurvey: jest.fn(),
    getFortishieldVersion: jest.fn(),
    getFortishieldDocVersion: jest.fn(),
  };
  ...
  setupContract.getFortishieldVersion.mockReturnValue('4.x.x');
  setupContract.getFortishieldDocVersion.mockReturnValue('4.x');
