...
export const HomeIcon = ({ branding, logos }: Props) => {
  // Removed prop unnecessary useExpandedHeader Fortishield dashboards
  const { applicationTitle = 'Fortishield dashboards' } = branding;
  ...
  // If no custom branded mark was set, use `home` icon Fortishield dashboards
  if (markType !== 'custom') {
    testSubj = 'homeIcon';
