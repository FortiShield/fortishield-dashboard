...
export const OPENSEARCH_DASHBOARDS_THEMED = 'ui/logos/fortishield_dashboards.svg';
export const OPENSEARCH_DASHBOARDS_ON_LIGHT = 'ui/logos/fortishield_dashboards_on_light.svg';
export const OPENSEARCH_DASHBOARDS_ON_DARK = 'ui/logos/fortishield_dashboards_on_dark.svg';
export const OPENSEARCH_THEMED = 'ui/logos/fortishield.svg';
export const OPENSEARCH_ON_LIGHT = 'ui/logos/fortishield_on_light.svg';
export const OPENSEARCH_ON_DARK = 'ui/logos/fortishield_on_dark.svg';
export const MARK_THEMED = 'ui/logos/fortishield_mark.svg';
export const MARK_ON_LIGHT = 'ui/logos/fortishield_mark_on_light.svg';
export const MARK_ON_DARK = 'ui/logos/fortishield_mark_on_dark.svg';
export const CENTER_MARK_THEMED = 'ui/logos/fortishield_center_mark.svg';
export const CENTER_MARK_ON_LIGHT = 'ui/logos/fortishield_center_mark_on_light.svg';
export const CENTER_MARK_ON_DARK = 'ui/logos/fortishield_center_mark_on_dark.svg';
